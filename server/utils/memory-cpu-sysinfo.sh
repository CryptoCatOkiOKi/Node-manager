...
AVERAGECPU=$(echo ${AVERAGECPU} | xargs printf "%.*f\n" 2)
...
echo -e "[ { \"runnig_nodes\": ${COUNTER1}, \"total_cpu\": ${TOTALCPU}, \"average_cpu\": ${AVERAGECPU}, \"total_memory_mb\": ${TOTALMEMMB}, \"total_memory_gb\": ${TOTALMEMGB}, \"average_memory_mb\": ${AVERAGEMEMMB}, \"free_memory_mb\": ${FREEMEMMB}, \"num_free_nodes_memory\": ${NUMOFFREENODESMEM}, \"num_free_nodes_cpu\": ${NUMOFFREENODESCPU} } ]"