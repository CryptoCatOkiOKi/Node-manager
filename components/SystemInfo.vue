    ...
    <div>
        <b-list-group v-for="sysInfo in sysInfos" :key="sysInfo._id">
          ...
          <b-list-group-item id="system-info">
            ...
            <b>Free memory for approx. {{sysInfo.num_free_nodes_memory}} new nodes<br>
            Free CPU for approx. {{sysInfo.num_free_nodes_cpu}} new nodes<br></b>
          </b-list-group-item>

          <nuxt-link :to="{name: 'active', params: { activeNodes: true } }" class="pluslink">
            <b-list-group-item class="d-flex justify-content-between align-items-center"  
              button
            ...
            >
              Active 
              <b-badge v-for="nodeCount in nodesCount" :key="nodeCount._id" variant="success" pill> 
                {{nodeCount.active}}
              </b-badge>
            </b-list-group-item>
          </nuxt-link>

          <nuxt-link :to="{name: 'nonactive', params: { activeNodes: false } }" class="pluslink">
            <b-list-group-item class="d-flex justify-content-between align-items-center"  
              button
            ...
            >
              Non Active 
              <b-badge v-for="nodeCount in nodesCount" :key="nodeCount._id" variant="danger" pill> 
                {{nodeCount.notactive}}
              </b-badge>
            </b-list-group-item>
          </nuxt-link>

          <nuxt-link v-if="nodesPhantomCount > 0" :to="{name: 'phantom'}" class="pluslink">
            <b-list-group-item class="d-flex justify-content-between align-items-center"  
              button
